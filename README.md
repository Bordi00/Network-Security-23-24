...
- [Application Layer DoS attacks](#application-layer-dos-attacks)
...
- Resource-based: attacks which aim to consume all the target resources such as buffer, memory, cpu execution cap. In this category we can identify two sub-groups:
